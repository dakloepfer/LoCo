...
class Hawkins_Dataset(Dataset):
    ...
    def __init__(self, img_size, datasets_folder, dist_thresh=8):
        ...
        self.dataset_name = "hawkins_long_corridor"
        ...
        self.gt_poses = np.load(
            ...
            allow_pickle=True,
        )  # returns dictionary of Hawkins dataset

        self.db_gt_arr = self.gt_poses[:127, :2]
        self.query_gt_arr = self.gt_poses[127:245, :2]
