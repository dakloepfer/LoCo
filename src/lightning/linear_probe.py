...
class LinearProbeModule(pl.LightningModule):
    ...
    def __init__(self, config, n_valid_objects, n_stuff_class_objects):
        super().__init__()
        self.config = config

        self.feature_dim = config.model.network.feature_dim

        self.n_objects = n_valid_objects + len(n_stuff_class_objects)
        ...
        self.n_stuff_objects = n_stuff_class_objects
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log("linear_probe_train/loss", loss)
        return loss
